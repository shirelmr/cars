...
- Nancy Reyes:Esta actividad resultó ser una experiencia entretenida pero tambien de mucho aprendizaje, ya que me permitió profundizar en el estudio y la aplicación de sistemas multiagente, así como en su representación visual interactiva. Durante el desarrollo de la simulación de tráfico, comprendí con mayor claridad la relevancia de la coordinación entre los distintos agentes en este caso los vehículos y los semaforos de esta simulación y el impacto que tienen las decisiones de diseño en el comportamiento global del sistema. Asimismo, la incorporación de herramientas de visualización y monitoreo en tiempo real me brindó una nueva apreciación sobre el valor de la retroalimentación visual en entornos complejos. Esta experiencia no solo me permitió aprender más respecto a  mis conocimientos en Julia (lenguaje nuevo para mi) y React (ya habia trabajado en este lenguaje), sino que también me permitió reconocer el potencial de los sistemas multiagente para modelar escenarios del mundo real y entender más a fondo cómo pueden interactuar diferentes agentes entre sí.